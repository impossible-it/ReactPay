...
const CardSelectionEnglish = () => {
  // Set 'card2' as the default selected card
  ...
  const handleSubmit = () => {
    switch (selectedCard) {
      ...
      case 'card3':
      default:
        navigate('/transferengfa/createrequestfa', { state: { selectedCard } });
        break;
    }
  };
      ...
      <div className="container mx-auto md:p-4 p-8 md:mt-16 mt-0">
        <div className="grid grid-cols-1 2xl:grid-cols-1 gap-8 justify-items-center my-8">
          ...
          >
            ...
            <p className="text-center mb-4 md:mb-12 px-2 md:px-6">
              Facilitates payments via credit or debit cards on behalf of merchants
            </p>
            <button
        ...
        <div className="flex justify-center md:mt-24 mt-16 my-8 md:my-24">
          <button
            ...
            // Button is not disabled since a card is selected by default
...
export default CardSelectionEnglish;