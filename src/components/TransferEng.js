  ...
  return (
    <div className="flex items-start justify-center min-h-screen bg-gray-fon px-4">
      <div className="container mx-auto md:p-4 p-8 md:mt-16 mt-0">
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-8 justify-items-center my-8">
          {/* <div
          ...
          <div
            className={`flex flex-col items-center w-full lg:w-[40%] md:w-[35%] bg-white p-8 rounded-lg ${selectedCard === 'card3' ? 'shadow-md bg-grayth' : ''} border-0 cursor-pointer transition transform hover:scale-105 ${selectedCard === 'card3' ? 'hover:shadow-2xl' : 'hover:shadow-lg'}`}
          ...
          >
            ...
            <button
              className={`py-2 px-4 mb-4 md:mb-10 rounded-md w-24 md:w-80 h-12 md:h-14 text-white font-bold ${selectedCard === 'card3' ? 'text-purpleth' : 'text-purpleth hover:bg-purple-950 hover:text-white'}`}
            >
