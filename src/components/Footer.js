  ...
  return (
    <footer className="bg-white shadow-md py-8">
      <div className="container mx-auto flex flex-col-reverse md:flex-row justify-between items-start space-y-8 md:space-y-0">
        <div className="w-full md:w-3/8 md:mb-0 text-gray-700 text-left px-4 md:px-0">
          ...
          <p className="mb-3 md:mb-6 text-xs w-full max-w-xs">Россия, 117648, г. Москва, мкр. Чертаново Северное, д. 1А, корп.1</p>
        ...
        <div className="w-full md:w-3/8 md:ml-0 ml-2 px-4 md:px-8">
        ...
        <div className="w-full md:w-2/8 mb-6 mt-6 md:mb-0 px-4 md:px-8">
        ...
        <div className="w-full md:w-1/4 mb-6 md:mb-0 flex justify-end md:justify-start px-4">
          <div className="flex flex-col items-center space-y-4 md:space-y-8 md:mt-0 mt-6">
